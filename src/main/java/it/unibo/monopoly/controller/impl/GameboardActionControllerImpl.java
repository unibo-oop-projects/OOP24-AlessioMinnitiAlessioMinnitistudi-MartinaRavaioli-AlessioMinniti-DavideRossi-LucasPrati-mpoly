...
public class GameboardActionControllerImpl implements GameboardActionController{
    ...
    public void changePositions() {
        ...
        gameboardView.changePos(((TurnationManagerImpl) this.turnManager).getIdCurrPlayer(),((BoardImpl) this.gameboard).getPawn(((TurnationManagerImpl) this.turnManager).getIdCurrPlayer()).getPosition());
    }
