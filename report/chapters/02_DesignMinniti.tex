...
e le librerie esterne non ne forninvano una adeguata

SOLUZIONE:
Per risolvere questo problema ho utilizzato il pattern \textbf{iterator}, andando a creare un' interfaccia \textbf{PlayerIterator} che estende iterator 
e serve a definire le azioni cardine del circular player iterator che oltre ad avere i metodi di un iterator normale possiede anche funzioni aggiuntive per gestire la lista di player,
