...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{ArchitectureDiagram-Pagina-4.drawio.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{ArchitectureDiagram-Pagina-3.drawio.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{ArchitectureDiagram-Pagina-2.drawio.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{ArchitectureDiagram-Pagina-1.drawio.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{ArchitectureDiagram-Pagina-5.drawio.png}
